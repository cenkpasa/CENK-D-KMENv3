                ...
                <div className="p-2 border bg-gray-100 shadow-inner">
                    ...
                    <div className="space-y-2 text-xs">
                        ...
                        <div className="text-right">
                            <button onClick={handleAddLeave} className="px-4 py-1 bg-blue-500 text-white font-bold rounded shadow-md border border-blue-700 hover:bg-blue-600 flex items-center justify-center w-full">
